...
CloudNativePG, External Secrets Operator, OpenShift AI serving runtimes) do
not have a directory here — their `application.yaml` points at the upstream
`repoURL`/`chart` instead.

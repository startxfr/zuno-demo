...
_GENERATE_IMAGE_TOOL_SCHEMA = {
    ...
    "function": {
        ...
        "description": (
            ...
            "when the user's request calls for a picture, illustration, or a marketing "
            "visual/mockup with no structured data in it (e.g. a product shot, a booth "
            "mockup, a mascot illustration) - NOT for a mockup or visualization OF "
            "structured or deal data (a chart, a pie chart, deal/pipeline figures), and "
            "NOT for diagrams, charts, schemas or sequence/workflow diagrams needing "
            "precise structure or legible text (use generate_diagram for all of those "
            "instead; SDXL cannot render exact boxes, arrows, text or real numbers "
            "reliably). Only pass the visual description itself as the prompt - never "
            ...
            "properties": {
                "mermaid_source": {
                    ...
                    "description": (
                        ...
                        "Flowchart/graph node labels: if a label inside [ ], ( ), or "
                        "{ } contains parentheses, pipes, commas, or other special "
                        "characters, wrap the WHOLE label in double quotes, e.g. "
                        "B[\"Create new ReplicaSet (v1)\"] or "
                        "C{\"targets (label selector)\"} - never leave special "
                        "characters unquoted inside a node shape, this is a parse "

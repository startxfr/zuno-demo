# v0.3 roadmap decisions (ADR-0301 – ADR-0309; see also ADR-0326, ADR-0327, ADR-0340, ADR-0342)
...
Promoted to a full decision record: see [ADR-0306](0306-expand-the-agent-catalog-beyond-the-initial-five-agents.md) (WP-41 implementation).

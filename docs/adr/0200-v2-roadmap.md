# v2 roadmap decisions (ADR-0201 – ADR-0209, excluding promoted entries)
...
Each of the 8 decisions below was promoted to its own full decision record as the design matured; two further decisions originally numbered here (ADR-0207 and ADR-0210) were promoted to the v1 stream on 2026-08-13 as [ADR-0116](0116-decouple-logical-tool-capabilities-from-physical-backend-bindings.md) and [ADR-0117](0117-implement-confluence-as-the-first-real-external-mcp-integration.md) because they are concretely implementable now. Only the Decision line is unique per entry - [Standard clauses](README.md#standard-clauses) (Context, Alternatives, Consequences, Security/Operational considerations, Migration/evolution, Related ADRs) apply to every entry unless overridden here.

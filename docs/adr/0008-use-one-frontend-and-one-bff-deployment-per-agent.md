...
Provide isolation and per-agent configuration while reusing common frontend and BFF codebases.
...
Future changes must be documented by a new ADR using `Supersedes ADR-0008` when applicable.

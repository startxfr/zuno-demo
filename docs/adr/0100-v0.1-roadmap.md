...
ADR-0350 – ADR-0117 are full decision records in their own files, moved into the v0.1 stream because they are open work targeted at v0.1: three formerly-00xx decisions that were never implemented, plus two decisions promoted from the v0.2 stream because they are concretely implementable now.

### ADR-0350: Provide an AIAgent Kubernetes CRD and operator

Formerly ADR-0026: see [ADR-0350](0350-provide-an-aiagent-kubernetes-crd-and-operator.md).

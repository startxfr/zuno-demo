...
ADR-0334 applies the same least-privilege pattern to RAG/knowledge access. Tool authorization remains a five-factor intersection; knowledge authorization is a separate, analogous intersection and must not be collapsed into tool permissions or frontend visibility.

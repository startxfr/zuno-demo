...
| [ADR-0526](0526-fine-tune-and-serve-a-french-urban-register-model-variant.md) | v0.4 | Proposed | Fine-tune and serve a French urban-register model variant (`-wesh`) beside its base |

...
| [ADR-0530](0530-reconcile-keycloak-clients-instead-of-relying-on-a-create-only-realm-import.md) | v0.4 | Proposed | Reconcile Keycloak clients instead of relying on a create-only realm import |

...
| [ADR-0550](0550-demonstrate-sovereign-ai-through-classification-specialization-and-resilience.md) | Implemented | Demonstrate sovereign AI through classification, specialization and resilience |
...
| ADR | Status | Decision |
|---|---|---|
| [ADR-0517](0517-redeploy-the-full-platform-from-scratch-on-a-new-demo333-cluster.md) | Implemented | Redeploy the full platform from scratch on a new demo333 cluster |
...
| [ADR-0546](0546-introduce-a-cross-cluster-source-bucket-and-per-cluster-s3-bucket-convention.md) | Implemented | Introduce a cross-cluster source bucket (`zuno-demo-sources`) and per-cluster S3 bucket convention (`zuno-<cluster>-xxx`) |
| [ADR-0547](0547-parameterize-every-cluster-specific-value-in-ansible.md) | Implemented | Parameterize every cluster-specific value in Ansible, and seed it through Vault when secret |
...
| [ADR-0557](0557-manage-the-cluster-from-a-remote-argocd-natively-or-via-rhacm.md) | Proposed | Manage the cluster from a remote ArgoCD, natively or via RHACM |

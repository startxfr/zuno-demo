...
| [ADR-0551](0551-add-namespace-scoped-perses-dashboards-alongside-grafana.md) | Accepted | Add namespace-scoped Perses dashboards alongside the existing Grafana stack |

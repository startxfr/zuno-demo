...
Create twenty initial quality scenarios per agent, approximately one hundred total.
...
Future changes must be documented by a new ADR using `Supersedes ADR-0027` when applicable.

...
Commit only anonymized or synthetic business fixtures; never commit real SXA records or nominative data.
...
Future changes must be documented by a new ADR using `Supersedes ADR-0025` when applicable.

...
(2026-08-18: the per-agent task-tab portion of this decision is delivered early by [ADR-0505](0505-open-okf-tasks-as-concurrent-per-agent-frontend-tabs.md) in the OKF stream; the broader structured-view scope stays here.)

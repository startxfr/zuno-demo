...
`make day1|d1 check agents` is the automated form of this gate (the ADR-0053 acceptance/security gate); see `docs/platform/installation.md` and `docs/platform/troubleshooting.md`.

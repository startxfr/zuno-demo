...
- **OGX**: the OpenShift AI OGX Operator (ADR-0322), activated in the `DataScienceCluster` (v0) with an OGX-backed RAG provider planned behind Zuno's retrieval contract (v1), while retaining explicit application-runtime boundaries.

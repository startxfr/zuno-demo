...
// Setting spec.host on a Route additionally requires create on
// routes/custom-host, or the apiserver rejects the write with
// "spec.host: Forbidden" (envtest cannot catch this - no OpenShift route
// admission plugin there).

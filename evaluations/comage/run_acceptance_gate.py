#!/usr/bin/env python3
"""Thin AGENT=comage wrapper around the canonical, shared
evaluations/tekos/run_acceptance_gate.py (ADR-0342/WP-33). Combines this
...
(ansible/roles/agents/tasks/check.yml) - WP-33 part (c)'s scenarios
...
Run directly:
    ...
    cd evaluations/comage && python3 run_acceptance_gate.py
"""
...
os.environ.setdefault("TASK_NAME", "check-deal-status")

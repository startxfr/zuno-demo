...
evaluations/tekos/run_acceptance_gate.py (ADR-0342/WP-35). Combines this
...
(ansible/roles/agents/tasks/check.yml) - WP-35 part (c)'s scenarios
...
Run directly:
    ...
    cd evaluations/advantage && python3 run_acceptance_gate.py
"""

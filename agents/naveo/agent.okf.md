...
|---|---|---|---|---|---|
| `answer-onboarding-question` (primary; prompt: `prompts/answer-onboarding-question.md`) | `C1` | `local-qwen35-maas` | `local-qwen35`, `local-gpt-oss-maas`, `local-gpt-oss`, `local-maas`, `local`, `local-wesh-maas`, `local-wesh`, `openai`, `gemini`, `anthropic`, `mistral`, `mistral-codestral`, `ovhcloud-gpt-oss-120b` | — | `policies/model-routing/model-routing-policy.yaml` |

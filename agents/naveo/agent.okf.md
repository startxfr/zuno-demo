...
|---|---|---|---|---|---|
| `answer-onboarding-question` (primary; prompt: `prompts/answer-onboarding-question.md`) | `C1` | `local-maas` | `local`, `local-gpt-oss-maas`, `local-gpt-oss`, `local-wesh-maas`, `local-wesh`, `local-qwen35-maas`, `local-qwen35`, `openai`, `gemini`, `anthropic`, `mistral`, `mistral-codestral`, `ovhcloud-gpt-oss-120b` | — | `policies/model-routing/model-routing-policy.yaml` |

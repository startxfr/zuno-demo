...
|---|---|---|---|---|---|
| `draft-architecture-testimonial` (primary; prompt: `prompts/draft-architecture-testimonial.md`) (no project / baseline) | `C1` | `ovhcloud-gpt-oss-120b` → `gpt-oss-120b` (reasoning-external) | `local-gpt-oss-maas`, `local-gpt-oss`, `local-maas`, `local`, `local-wesh-maas`, `local-wesh`, `local-qwen35-maas`, `local-qwen35`, `openai`, `gemini`, `anthropic`, `mistral`, `mistral-codestral` | — | `policies/model-routing/model-routing-policy.yaml` |
| `draft-architecture-testimonial` (primary; prompt: `prompts/draft-architecture-testimonial.md`) (in a classified project) | `C2/C3` | `local-gpt-oss-maas` → `gpt-oss-20b` (reasoning) | `local-gpt-oss`, `local-maas`, `local`, `local-wesh-maas`, `local-wesh`, `local-qwen35-maas`, `local-qwen35` | — | `policies/model-routing/model-routing-policy.yaml` |

...
|---|---|---|---|---|---|
| `answer-technical-question` (primary; prompt: `prompts/answer-technical-question.md`) | `C1` | `ovhcloud-gpt-oss-120b` | `local-gpt-oss-maas`, `local-gpt-oss`, `local-qwen35-maas`, `local-qwen35`, `local-wesh-maas`, `local-wesh`, `local-maas`, `local`, `openai`, `gemini`, `anthropic`, `mistral`, `mistral-codestral` | — | `policies/model-routing/model-routing-policy.yaml` |
| `find-relevant-docs` | `C1` | `local-qwen35-maas` | `local-qwen35`, `local-wesh-maas`, `local-wesh`, `local-maas`, `local`, `local-gpt-oss-maas`, `local-gpt-oss`, `ovhcloud-gpt-oss-120b`, `openai`, `gemini`, `anthropic`, `mistral`, `mistral-codestral` | — | `policies/model-routing/model-routing-policy.yaml` |
| `check-my-drive-docs` | `C1` | `local-qwen35-maas` | `local-qwen35`, `local-wesh-maas`, `local-wesh`, `local-maas`, `local`, `local-gpt-oss-maas`, `local-gpt-oss`, `ovhcloud-gpt-oss-120b`, `openai`, `gemini`, `anthropic`, `mistral`, `mistral-codestral` | — | `policies/model-routing/model-routing-policy.yaml` |

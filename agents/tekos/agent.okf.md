...
|---|---|---|---|---|---|---|---|---|
| `answer-technical-question` (primary; prompt: `prompts/answer-technical-question.md`) | `search_confluence` (live-read) | tool | `confluence.page.search` @ confluence | C2 | consultant, board, cdp, lightspeed_readonly | blocked | `standard` (user 60 req/5m) | `tools/tool-policy.yaml` `search_confluence` |
...
| `answer-technical-question` (primary; prompt: `prompts/answer-technical-question.md`) | `diagram.generation.create` | tool | `diagram.generation.create` @ diagram-gen | C1 | consultant, adv, sales, board, cdp | allowed | `standard` (user 60 req/5m) | `tools/tool-policy.yaml` `generate_diagram` |
| `answer-technical-question` (primary; prompt: `prompts/answer-technical-question.md`) | `aap.platform.audit` | tool | `aap.platform.audit` @ aap | C2 | consultant, board, cdp | allowed | `standard` (user 60 req/5m) | `tools/tool-policy.yaml` `aap.platform.audit` |
| `answer-technical-question` (primary; prompt: `prompts/answer-technical-question.md`) | `aap.cluster.audit` | tool | `aap.cluster.audit` @ aap | C2 | consultant, board, cdp | allowed | `standard` (user 60 req/5m) | `tools/tool-policy.yaml` `aap.cluster.audit` |
...
| `find-relevant-docs` | `search_confluence` | tool | `confluence.page.search` @ confluence | C2 | consultant, board, cdp, lightspeed_readonly | blocked | `standard` (user 60 req/5m) | `tools/tool-policy.yaml` `search_confluence` |
...
|---|---|---|---|---|---|
| `answer-technical-question` (primary; prompt: `prompts/answer-technical-question.md`) | `C1` | `local-gpt-oss-maas` | `local-gpt-oss`, `local-wesh-maas`, `local-wesh`, `local-maas`, `local`, `ovhcloud-gpt-oss-120b`, `openai`, `gemini`, `anthropic`, `mistral`, `local-qwen35-maas`, `local-qwen35`, `mistral-codestral` | — | `policies/model-routing/model-routing-policy.yaml` |
| `find-relevant-docs` | `C1` | `local-maas` | `local`, `local-wesh-maas`, `local-wesh`, `local-gpt-oss-maas`, `local-gpt-oss`, `ovhcloud-gpt-oss-120b`, `openai`, `gemini`, `anthropic`, `mistral`, `local-qwen35-maas`, `local-qwen35`, `mistral-codestral` | — | `policies/model-routing/model-routing-policy.yaml` |
| `check-my-drive-docs` | `C1` | `local-maas` | `local`, `local-wesh-maas`, `local-wesh`, `local-gpt-oss-maas`, `local-gpt-oss`, `ovhcloud-gpt-oss-120b`, `openai`, `gemini`, `anthropic`, `mistral`, `local-qwen35-maas`, `local-qwen35`, `mistral-codestral` | — | `policies/model-routing/model-routing-policy.yaml` |
| `write-code` | `C1` | `mistral-codestral` | `local-wesh-maas`, `local-wesh`, `local-gpt-oss-maas`, `local-gpt-oss`, `local-maas`, `local`, `local-qwen35-maas`, `local-qwen35`, `openai`, `gemini`, `anthropic`, `mistral`, `ovhcloud-gpt-oss-120b` | — | `policies/model-routing/model-routing-policy.yaml` |

**Available models** (ADR-0419, generated): the union of every model reachable by any task or prompt slot above, at any classification - `local-maas`, `local`, `local-gpt-oss-maas`, `local-gpt-oss`, `local-wesh-maas`, `local-wesh`, `local-qwen35-maas`, `local-qwen35`, `openai`, `gemini`, `anthropic`, `mistral`, `mistral-codestral`, `ovhcloud-gpt-oss-120b`.

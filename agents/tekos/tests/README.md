...
(this directory) are Tekos-specific and need only repository files - no
cluster, no credentials, no model calls; **behavioral** checks stay in
`evaluations/tekos/` (ADR-0027/ADR-0028, the shared ADR-0342 runner).

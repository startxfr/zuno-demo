...
DAY0_COMPONENTS := admin-context argocd namespaces vault cert-manager external-secrets keycloak postgresql service-mesh smtp nfd nvidia-gpu observability connectivity-link lws openshift-ai

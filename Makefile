...
DAY0_COMPONENTS := admin-context argocd namespaces vault cert-manager external-secrets keycloak postgresql service-mesh tempo mesh-monitoring kiali smtp nfd nvidia-gpu observability connectivity-link lws openshift-ai
